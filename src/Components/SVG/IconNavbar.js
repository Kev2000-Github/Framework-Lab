...
export const Grafica = ({className}) => {
    return (
...
export const Contacto = ({className}) => {
    return (
        <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M2,20v2h8V20a4,4,0,0,0-1.62-3.2A3,3,0,0,0,9,15a3,3,0,0,0-6,0,3,3,0,0,0,.62,1.8A4,4,0,0,0,2,20Z"/>
        <path d="M20.38,6.8A3,3,0,0,0,21,5a3,3,0,0,0-6,0,3,3,0,0,0,.62,1.8A4,4,0,0,0,14,10v2h8V10A4,4,0,0,0,20.38,6.8Z"/><polygon points="5 11 7 11 7 7 13 7 13 5 5 5 5 11"/><polygon points="17 17 11 17 11 19 19 19 19 13 17 13 17 17"/></svg>
    )
}
...
export const Mail = ({className}) => {
    return (
        <svg className={className} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <path d="M29,6H3L2.92,6a.78.78,0,0,0-.21,0l-.17.07a.65.65,0,0,0-.15.1.67.67,0,0,0-.15.14l-.06.06a.36.36,0,0,0,0,.09,1.08,1.08,0,0,0-.08.19A1.29,1.29,0,0,0,2,6.9S2,7,2,7V25a1,1,0,0,0,1,1H29a1,1,0,0,0,1-1V7A1, 1,0,0,0,29,6ZM16,14.81,6.2,8H27.09ZM4,24V8.91l11.43,7.91,0,0a1.51,1.51,0,0,0,.18.09l.08,0A1.09,1.09,0,0,0,16,17h0a1,1,0,0,0,.41-.1l.07,0,0,0L28,9.79V24Z"/></svg>
    )
}

export const Trabajo = ({className}) => {
    return (
